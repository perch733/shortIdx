...
export var ShuffleX = function (array, limit) {
    var _a;
    ...
    var actualLimit = limit !== undefined ? limit : array.length;
...
export var RandomIdx = function (limit) {
    if (limit === void 0) { limit = 7; }
